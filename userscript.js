    ...
    fetch(VERSION_JSON_URL)
      ...
      .then((data) => {
        ...
        if (updateVersion && CURRENT_VERSION !== updateVersion) {
          showModal(
            `🚩 GeoFS flightradar receiver new version available (${updateVersion})!<br>Please reinstall the latest user.js from GitHub.`,
            null,
            UPDATE_URL
          );
        }
      ...
      .catch(() => {
        showModal("Error loading update information");
      });
  })();
